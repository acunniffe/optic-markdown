...
var grammar = {
    ...
    {"name": "packageRef$ebnf$1$subexpression$1", "symbols": [/[\da-zA-Z-><\+:]/]},
    {"name": "packageRef$ebnf$1", "symbols": ["packageRef$ebnf$1$subexpression$1"]},
    {"name": "packageRef$ebnf$1$subexpression$2", "symbols": [/[\da-zA-Z-><\+:]/]},
    ...
    {"name": "assignmentProperty$subexpression$1$subexpression$1$string$4", "symbols": [{"literal":"y"}, {"literal":"i"}, {"literal":"e"}, {"literal":"l"}, {"literal":"d"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "assignmentProperty$subexpression$1$subexpression$1$string$5", "symbols": [{"literal":"a"}, {"literal":"u"}, {"literal":"t"}, {"literal":"h"}, {"literal":"o"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "assignmentProperty$subexpression$1$subexpression$1$string$6", "symbols": [{"literal":"v"}, {"literal":"e"}, {"literal":"r"}, {"literal":"s"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "assignmentProperty$subexpression$1$subexpression$1$string$7", "symbols": [{"literal":"l"}, {"literal":"a"}, {"literal":"n"}, {"literal":"g"}, {"literal":"u"}, {"literal":"a"}, {"literal":"g"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "assignmentProperty$subexpression$1$subexpression$1$string$8", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"p"}, {"literal":"u"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
